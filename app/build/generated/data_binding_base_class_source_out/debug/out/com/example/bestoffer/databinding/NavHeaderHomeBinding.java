...
public final class NavHeaderHomeBinding implements ViewBinding {
  ...
  private NavHeaderHomeBinding(@NonNull LinearLayout rootView, @NonNull ImageView userProfileImage,
      @NonNull TextView userProfileName) {
  ...
  public static NavHeaderHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView userProfileImage = rootView.findViewById(id);
