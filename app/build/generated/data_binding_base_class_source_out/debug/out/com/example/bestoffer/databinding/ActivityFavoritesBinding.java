...
public final class ActivityFavoritesBinding implements ViewBinding {
  ...
  private ActivityFavoritesBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView backIv,
      @NonNull RecyclerView favoritesRv, @NonNull ConstraintLayout toolBar) {
  ...
  public static ActivityFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.favoritesRv;
      RecyclerView favoritesRv = rootView.findViewById(id);
      if (favoritesRv == null) {
        break missingId;
      }
      ...
      return new ActivityFavoritesBinding((ConstraintLayout) rootView, backIv, favoritesRv,
          toolBar);
    }
